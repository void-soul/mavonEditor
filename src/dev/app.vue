<template>
  <div id="app">
    ...
    <section class="page-header">
      ...
      <a href="https://github.com/hinesboy/mavonEditor/zipball/master"
         class="btn">Download .zip</a>
      <a href="https://github.com/hinesboy/mavonEditor/master"
         class="btn">Download .tar.gz</a>
    </section>
    <div v-if="!screen_phone"
         class="item">
    ...
    <div v-if="screen_phone"
      ...
      <mavon-editor :language="d_language"
                    @save="savetwo"
                    :toolbars="toolbars"
                    class="item-editor"
    ...
    <div class="item">
      <span style="display: block;margin: 30px 0 15px 0;color: #1e6bb8"
            class="">
        {{d_words.mark}}
      </span>
    </div>
