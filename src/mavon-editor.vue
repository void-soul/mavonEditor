<template>
  <div :class="[{'fullscreen': s_fullScreen}]"
       class="v-note-wrapper markdown-body">
    <!--工具栏-->
    <div class="v-note-op"
         v-show="toolbarsFlag"
         :class="{'shadow': boxShadow}">
      <v-md-toolbar-left ref="toolbar_left"
                         :editable="editable"
                         :d_words="d_words"
      ...
      <v-md-toolbar-right ref="toolbar_right"
                          :d_words="d_words"
    ...
    <div class="v-note-panel"
      ...
      <div ref="vNoteEdit"
        ...
        <div class="content-input-wrapper">
          <!-- 双栏 -->
          <v-autoTextarea ref="vNoteTextarea"
                          :placeholder="placeholder ? placeholder : d_words.start_editor"
                          class="content-input"
                          :fontSize="fontSize"
                          lineHeight="1.5"
                          v-model="d_value"
                          fullHeight></v-autoTextarea>
        </div>
      </div>
      <!--展示区-->
      ...
      <div ref="help">
        <div @click="toolbar_right_click('help')"
          ...
          <div class="v-note-help-content markdown-body"
               :class="{'shadow': boxShadow}">
            <i @click.stop.prevent="toolbar_right_click('help')"
